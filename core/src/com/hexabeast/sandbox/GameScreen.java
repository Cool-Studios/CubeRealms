...
{	
	...
	private void UpdateCamera()
	{
		...
		Vector3 newpos = Tools.Lerp(camera.position,new Vector3((player.PNJ.x+player.PNJ.width/2), (player.PNJ.y+player.PNJ.height/2), 10));
	...
	private void UpdateAndDrawRenderer(){
		...
		Shaders.instance.setShadowShader();
			...
			batch.begin();
				...
				entities.projectiles.UpdateGrapples(batch);
				player.Update();
	...
	public static boolean isVillage()
	{
        ...
        return player.PNJ.x < Map.villageWidth * 16 && player.PNJ.y > Map.instance.height * 16 - Map.villageHeight * 16;
    }
}
