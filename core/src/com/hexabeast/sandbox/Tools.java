...
public class Tools {
	...
	public static boolean isClicked(Sprite spr, float degre)
	{
        ...
        return (coord.x > spr.getX() - degre && coord.x < spr.getX() + spr.getScaleX() * spr.getWidth() + degre) && (coord.y > spr.getY() - degre && coord.y < spr.getY() + spr.getHeight() * spr.getScaleY() + degre);
	}
